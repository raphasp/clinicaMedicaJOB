				...
				<fieldset>
					...
					<div class="col-lg-12">
						<div class="form-group col-lg-12">
							...
							<div class="input-back-job">
								<input class="form-control input-lg input-job" id='name' name='name' type='text' required='true' placeholder='Abc...z' >
							</div>
						</div>
					</div>
					<div class="col-lg-12">
						<div class="form-group  col-lg-12">
							...
							<div class="input-back-job">
								<input class="form-control input-lg input-job" id='lastpaternal' name='lastpaternal' type='text' required='true' placeholder='Abc...z' >
							</div>
						</div>
					</div>
					<div class="col-lg-12">
						<div class="form-group col-lg-12">
							...
							<div class="input-back-job">
								<input class="form-control input-lg input-job" id='lastmaternal' name='lastmaternal' type='text' required='true' placeholder='Abc...z' >
							</div>
						</div>
					</div>
					<div class="col-lg-12">
					...
					<div class="col-lg-12">
						<div class="form-group col-lg-12">
							...
							<div class="input-back-job">
								<input class="form-control input-lg input-job" id="password" name="password" type="text" required placeholder="Abc...z123456789">
							</div>
						</div>
					</div>
					<div class="col-lg-12">
