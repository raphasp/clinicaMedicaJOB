...
<head>
	...
	<?php
		...
		$menu->headerLinksCSS();
	?>
	<script type='text/javascript' src='js/patientsUpdata.js'></script>
</head>
<body>
	<?php
	...
	<div class="container margintopconteiner" >
		<form role="form" class="col-lg-12" id="patientAdd" action='class/patientUpdata.php' method="post">
			<fieldset class="col-lg-12 divmargin">
				<legend>Ficha del paciente</legend>
				<div class="btn-arrows-cal">
					<a id="print-patient" href="patientSearch.php" class="btn btn-job-arrow" data-toggle="tooltip" data-placement="bottom" title="Imprimir Expediente"><span class="glyphicon glyphicon-print"></span></a>
					<a id="edit-patient" class="btn btn-job-arrow" data-toggle="tooltip" data-placement="bottom" title="Editar Expediente"><span class="glyphicon glyphicon-edit" ></span></a>
					<a id="consult-patient" href="#" class="btn btn-job-arrow" data-toggle="tooltip" data-placement="bottom" title="Sacar Cita"><span class="glyphicon glyphicon-list-alt"></span></a>
				</div>
				<div class="col-md-12" id="divid">
					...
					<div class="input-back-job-sm form-group has-feedback">
						<input class="form-control input-sm input-job " id='id' name='id' type='text' placeholder='Abc...z' disabled required <?php echo "value='".$_GET['code']."'";?>>
					</div>
				</div>
				<div class="col-md-3">
					<label class="control-label form-group has-feedback">Nombre</label>
					<div class="input-back-job-sm form-group has-feedback">
						<input class="form-control input-sm input-job " id='name' name='name' type='text' placeholder='Abc...z' required disabled>
					</div>
				</div>
				<div class="col-md-3 col-md-offset-1">
					<label class="control-label form-group has-feedback">Apellido Paterno</label>
					<div class="input-back-job-sm form-group has-feedback">
						<input class="form-control input-sm input-job" id='app' name='app' type='text' placeholder='Abc...z' required disabled>
					</div>
				</div>
				<div class="col-md-3 col-md-offset-1">
					<label class="control-label form-group has-feedback">Apellido Materno</label>
					<div class="input-back-job-sm form-group has-feedback">
						<input class="form-control input-sm input-job" id='apm' name='apm' type='text' placeholder='Abc...z' required disabled>
					</div>
				</div>
				<div class="col-md-3">
					<label class="control-label form-group has-feedback">Sexo</label>
					<div class="input-back-job-sm form-group has-feedback">
						<select class="form-control input-sm input-job  select-job" id="sex" name="sex" required disabled>
							<option value=""></option>
				...
				<div class="col-md-3 col-md-offset-1">
					...
					<div class="input-back-job-sm form-group has-feedback">
						<input class="form-control input-sm input-job select-job" id="borndate" name="borndate" type="date" required placeholder="" disabled>
					</div>
				</div>
				<div class="col-md-3 col-md-offset-1">
					<label class="control-label form-group has-feedback">Edad</label>
					<div class="input-back-job-sm form-group has-feedback">
						<input class="form-control input-sm input-job" id='age' name='age' type='text' placeholder='0123456789' required disabled>
					</div>
				...
				<div class="col-md-3">
					...
					<div class="input-back-job-sm form-group has-feedback">
						<select class="form-control input-sm input-job  select-job" id="bloodgroup" name="bloodgroup" disabled>
							<option value=""></option>
				...
				<div class="col-md-3 col-md-offset-1">
					...
					<div class="input-back-job-sm form-group has-feedback">
						<input class="form-control input-sm input-job " id='phone' name='phone' type='text' placeholder='(999)-999-9999' disabled>
					</div>
				</div>
				<div class="col-md-3 col-md-offset-1">
					<label class="control-label form-group has-feedback">Teléfono Móvil</label>
					<div class="input-back-job-sm form-group has-feedback">
						<input class="form-control input-sm input-job " id='cellphone' name='cellphone' type='text' placeholder='(999)-999-9999' disabled>
					</div>
				</div>
				<div class="col-md-3">
					<label class="control-label form-group has-feedback">Estado Marital</label>
					<div class="input-back-job-sm form-group has-feedback">
						<select class="form-control input-sm input-job  select-job" id="marital" name="marital" disabled>
							<option value=""></option>
				...
				<div class="col-md-7 col-md-offset-1">
					...
					<div class="input-back-job-lg form-group has-feedback">
						<input class="form-control input-sm input-job " id='address' name='address' type='text' placeholder='Calle, Colonía y No.' required disabled>
					</div>
				</div>
				<div class="col-md-3">
					<label class="control-label form-group has-feedback">Localidad</label>
					<div class="input-back-job-sm form-group has-feedback">
						<input class="form-control input-sm input-job" id='community' name='community' type='text' placeholder='Abc...z' required disabled>
					</div>
				</div>
				<div class="col-md-3 col-md-offset-1">
					<label class="control-label form-group has-feedback">Municipio</label>
					<div class="input-back-job-sm form-group has-feedback">
						<input class="form-control input-sm input-job " id='municipaly' name='municipaly' type='text' placeholder='Abc...z' required disabled>
					</div>
				</div>
				<div class="col-md-3 col-md-offset-1">
					<label class="control-label form-group has-feedback">Código Postal</label>
					<div class="input-back-job-sm form-group has-feedback">
						<input class="form-control input-sm input-job " id='code' name='code' type='text' placeholder='Abc...z' disabled>
					</div>
				</div>
				<div class="col-md-3">
					<label class="control-label form-group has-feedback">Escolaridad</label>
					<div class="input-back-job-sm form-group has-feedback">
						<select class="form-control input-sm input-job  select-job" id="levelschool" name="levelschool" disabled>
				...
				<div class="col-md-3 col-md-offset-1">
					...
					<div class="input-back-job-sm form-group has-feedback">
						<input class="form-control input-sm input-job " id='profesional' name='profecional' type='text' placeholder='Abc...z' disabled>
					</div>
				</div>
				<div class="col-md-3 col-md-offset-1">
					<label class="control-label form-group has-feedback">Religión</label>
					<div class="input-back-job-sm form-group has-feedback">
						<input class="form-control input-sm input-job " id='religion' name='religion' type='text' placeholder='Abc...z' disabled>
					</div>
				</div>
				<div class="col-md-3">
					<label class="control-label form-group has-feedback">Email</label>
					<div class="input-back-job-lg form-group has-feedback">
						<input class="form-control input-sm input-job " id='email' name='email' type='email' placeholder='Abc...z' disabled>
					</div>
				</div>
				<div class="col-md-7 col-md-offset-1">
					<label class="control-label form-group has-feedback">Observaciones</label>
					<div class="input-back-job-lg form-group has-feedback">
						<input class="form-control input-sm input-job" id='observation' name='observation' type='text' placeholder='Abc...z' disabled>
					</div>
				</div>
			</fieldset>
			...
			<div class="col-md-offset-1 col-md-1" id="btnreset">
				<a id="cleanall" href="reception.php" class="btn btn-job"><span class="glyphicon glyphicon-remove"></span>Cancelar</a>
			</div>
			<div class="col-md-offset-1 col-md-1" id="btnsubmit">
				<button type="submit" id="btnSubmit" class="btn btn-job"><span class="glyphicon glyphicon-ok"></span>     Actualizar</button>
			</div>
	</form>	
	</div>
	  ...
	  <div class="modal-dialog modal-lg">
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <div class="checkboxtab divhidden">
				<label>
	...
	<div class="modal fade" id="formConsultModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	  <div class="modal-dialog">
	    <div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
	        <h4 class="modal-title" id="myModalLabel">Descripción de la Cita</h4>
	      </div>
	      <div class="modal-body">
	        <div class="col-md-12">
				<form id="formConsult" method="post" action="class/patientConsult.php">
					<div class="col-md-12" id="divid">
						<label class="control-label form-group has-feedback">Id</label>
						<div class="input-back-job-lg form-group has-feedback">
							<input class="form-control input-sm input-job" id='idpatient' name='idpatient' type='text' placeholder='Abc...z' readonly>
						</div>
					</div>
					<div class="col-md-12">
						<label class="control-label form-group has-feedback">Paciente</label>
						<div class="input-back-job-lg form-group has-feedback">
							<input class="form-control input-sm input-job" id='patient' name='patient' type='text' placeholder='Abc...z' required readonly>
						</div>
					</div>
					<div class="col-md-6">
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="button" id="btnConsult" class="btn btn-default">Aceptar</button>
	      </div>
	    </div>
	  </div>
	</div>
	...
	function main(){
	    ...
	    $("#edit-patient").tooltip();
		$("#consult-patient").tooltip();
	}
	</script>
</body>
<?php
